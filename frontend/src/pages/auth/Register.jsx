    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
        <div className="w-full max-w-md bg-white rounded-3xl shadow-xl p-8 text-center">
          ...
          <Link
            to="/login"
            className="mt-8 block w-full rounded-xl bg-slate-900 px-5 py-3.5 text-center font-semibold text-white transition hover:bg-slate-800"
          >
            Go to Sign In
          </Link>
        </div>
    ...
    <div className="min-h-screen bg-slate-50 px-4 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-8 text-center">
          <Link
            to="/"
            className="mb-4 inline-flex items-center justify-center gap-2 transition hover:opacity-80"
          >
          ...
          <p className="mt-2 text-slate-500">
            Join OpportunityX and unlock new opportunities. Already have an account?{" "}
            <Link
              to="/login"

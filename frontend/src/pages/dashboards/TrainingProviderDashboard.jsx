...
const TrainingProviderDashboard = () => {
  ...
  const handleImageUpload = (e) => {
    ...
    reader.onloadend = () => {
      ...
      setProgramForm((prev) => ({ ...prev, image: reader.result }));
    };
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 pb-20">
      {/* Header Banner */}
      <section className="bg-gradient-to-r from-emerald-800 via-teal-900 to-slate-950 px-4 py-12 text-white shadow-lg">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <button
                ...
                className="rounded-xl border border-white/20 bg-white/10 px-4 py-3 text-slate-200 hover:bg-red-600 hover:text-white transition"
                title="Log Out"
              >
                <LogOut size={18} />
              </button>
